                ...
                <c:forEach  var="employee" items='${requestScope["employeeList"]}'>
                    <tr>
                        ...
                        <td>${employee.getEmployeeId()}</td>
                            <%--                        <td>--%>
                            <%--                            <a href="/employees?action=view&id=${employee.getEmployeeId()}">--%>
                            <%--                                    ${employee.getEmployeeName()}--%>
                            <%--                            </a>--%>
                            <%--                        </td>--%>
                        <td>${employee.getEmployeeName()}</td>
                        <td>${employee.getPositionId()}</td>
                        <td>${employee.getLevelId()}</td>
                        <td>${employee.getDepartmentId()}</td>
                        <td>${employee.getDateOfBirth()}</td>
                        <td>${employee.getIdNumber()}</td>
                        <td>${employee.getSalary()}</td>
                        <td>${employee.getPhone()}</td>
                        <td>${employee.getEmail()}</td>
                        <td>${employee.getAddress()}</td>
                        <td>
                                <%--                            <a href="employees?action=edit&id=${employee.getEmployeeId()}" class="edit">--%>
                                <%--                                <i class="material-icons" data-toggle="tooltip" title="Edit">mode_edit</i>--%>
                                <%--                            </a>--%>
                                <%--                            <a href="employees?action=delete&id=${employee.getEmployeeId()}" class="delete">--%>
