                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-9 ">
                                <a href="/list_customer?action=add" class="btn btn-success">
                                    <i class="material-icons">add_circle</i> <span>Add New Customer</span></a>
                                <a href="/list_customer?action=search_by_name" class="btn btn-info">
                    ...
                    <table class="table table-striped table-hover" id="customerTable">
                        ...
                        <c:forEach var="customerDTO" items='${requestScope["customerDTOList"]}'>
                            <tr>
                                ...
                                <td>
                                    <a href="/list_customer?action=view&customerIdView=${customerDTO.getCustomerId()}">
                                ...
                                <td>
                                    <a href="/list_customer?action=edit&customerIdEdit=${customerDTO.getCustomerId()}" class="edit">
                                        <i class="material-icons" data-toggle="tooltip" title="Edit">mode_edit</i>
                                    </a>
                                    <a href="/list_customer?action=delete&customerIdDelete=${customerDTO.getCustomerId()}"
                                       class="delete">
